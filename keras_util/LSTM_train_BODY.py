...
def load_data(filename):
    ...
    while True:
        ...
        label.append(int(label_1.split('_')[-2]))
        _list.append(line[:-1])
    f.close()
    print(_list)
    ...
    for file in _list:
        ...
        try:
            ...
            df = df[1:]
            df2 = df[[str(i) for i in range(75)]]
...
df, label = load_data("../video_output/LSTM_DATASET2/csv_list_LSTM_BODY.txt")
label = label[0]
...
model.save('model_save/my_model_63_BODY.h5')
