...
#     hand_shape_dateset = [[0, 1, 1, 0, 0],  # 가위
#                           [1, 1, 0, 0, 0],  # 총
#                           [0, 0, 0, 0, 0],  # 바위
#                           [1, 1, 1, 1, 1],  # 보
#                           [1, 1, 0, 0, 1],  # 스파이더맨
...
#                           [0, 0, 1, 0, 0]  # Fuck you
#                           ]
#     for i in range(len(hand_shape_dateset)):
#         hand_shape_dateset[i] = list(map(bool, hand_shape_dateset[i]))  # boolean 원소로 지닌 list로 변환
#     hand_shape_name = ['가위', '총', '바위', '보', '스파이더맨', '따봉', 'Fuck you']
#
#     global image
#     if finger_open_ in hand_shape_dateset:
...
#         # x1, y1 = 30, 30
#
#         text = hand_shape_name[hand_shape_dateset.index(finger_open_)]
...
if __name__ == "__main__":
    ...
    while cap.isOpened():
            ...
            for i in range(len(mark_p_list)): #for문 한 번 도는게 한 손에 대한 것임
                ...
                if hm_idx == True:
                    ...
                    if use_tensorflow == True:
                        ...
                        static_gesture_num = HM.predict_static()
                        ...
                        # 정지 제스쳐 확인
                        static_gesture_detect(finger_open_, mark_p[-1])
        ...
        #print("FPS : ", 1/(time.time() - before_time))
        before_time = time.time()
